...
public class NmsHandler_v1_9_R1 implements ISuperiorNms {
    @Override
    public void setBlock(Location location, OMaterial material) {
        ...
        net.minecraft.server.v1_9_R1.World world = ((CraftWorld) location.getWorld()).getHandle();
        BlockPosition pos = new BlockPosition(location.getBlockX(), location.getBlockY(), location.getBlockZ());
        net.minecraft.server.v1_9_R1.Chunk chunk = world.getChunkAt(chunkX, chunkZ);
