...
public class Updater {
  ...
  private static void setLatestVersion() {
    ...
    // URL("https://bg-software.com/versions.json").openConnection();
    //
    //            connection.setRequestMethod("GET");
    //            connection.setRequestProperty("User-Agent", "Mozilla/5.0 (Windows; U; Windows NT
    // 6.1; en-GB;     rv:1.9.2.13) Gecko/20101203 Firefox/3.6.13 (.NET CLR 3.5.30729)");
    ...
    //                String description =
    // superiorprison.getAsJsonPrimitive("description").getAsString();
    //
