...
public class BombConfig {
    ...
    public BombConfig(ConfigSection section) {
        ...
        section.ifSectionPresent("sound", soundSection -> {
            sound = WrappedSound.of(OSound.match(soundSection.getAs("type")), soundSection.getAs("pitch", float.class), soundSection.getAs("volume", float.class));
        });
    }
