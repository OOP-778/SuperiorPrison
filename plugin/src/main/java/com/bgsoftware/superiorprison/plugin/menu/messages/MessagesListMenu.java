...
public class MessagesListMenu extends OPagedMenu<SMineMessage> implements OMenu.Templateable {
              ...
              SubscriptionFactory.getInstance()
                  .subscribeTo(
                      ...
                      chatEvent1 -> {
                        ...
                        LocaleEnum.MINE_MESSAGES_CREATE_INTERVAL
                            .getWithPrefix()
                            .send(chatEvent1.getPlayer());
                        ...
                        SubscriptionFactory.getInstance()
                            .subscribeTo(
                                ...
                                chatEvent2 -> {
                                  ...
                                  mine.save(true);
                                  messageBuilder(
                                          LocaleEnum.MINE_MESSAGES_CREATE_SUCCESS.getWithPrefix())
                                      .replace(message)
                                      .send(chatEvent2);
                      ...
                      new SubscriptionProperties<AsyncPlayerChatEvent>()
                          ...
                          .filter(
                              chatEvent1 ->
                                  chatEvent1.getMessage().equalsIgnoreCase("actionbar")
                                      || chatEvent1.getMessage().equalsIgnoreCase("title")
                                      || chatEvent1.getMessage().equalsIgnoreCase("chat")));
            });
  }
  ...
  public List<SMineMessage> requestObjects() {
    return mine.getMessages().get().stream()
