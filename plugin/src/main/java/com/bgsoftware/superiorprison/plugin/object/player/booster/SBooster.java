...
public abstract class SBooster implements Booster, SerializableObject {
  ...
  public static SBooster fromElement(SerializedData element) {
    ...
    if (type.equalsIgnoreCase("drops")) booster = new SDropsBooster();
    else if (type.equalsIgnoreCase("money")) booster = new SMoneyBooster();
    else if (type.equalsIgnoreCase("xp")) booster = new SXPBooster();
