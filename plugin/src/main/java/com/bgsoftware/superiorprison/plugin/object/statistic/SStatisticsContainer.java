...
public class SStatisticsContainer implements StatisticsContainer, UniversalBodyModel, Removeable {
  ...
  @Getter private SBlocksStatistic blocksStatistic = new SBlocksStatistic();

  @Getter private SPrisoner cachedPrisoner;
  ...
  public void remove() {
    ...
    SuperiorPrisonPlugin.getInstance()
        ...
        .getStorage(SStatisticHolder.class)
        .remove(this);
  }
