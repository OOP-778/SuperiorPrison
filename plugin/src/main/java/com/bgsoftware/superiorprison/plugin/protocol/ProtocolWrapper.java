...
public abstract class ProtocolWrapper {
	...
	private static final Field getMinecraftServer = OSimpleReflection.getField(findClass("{cb}.CraftServer"), minecraftServerClass);
	private static final Field getServerConnection = OSimpleReflection.getField(minecraftServerClass, serverConnectionClass);
	private static final Method getNetworkMarkers = OSimpleReflection.getTypedMethod(serverConnectionClass, null, List.class, serverConnectionClass);

	// Packets we have to intercept
	private static final Class<?> PACKET_LOGIN_IN_START = findClass("{nms}.PacketLoginInStart");
	 ...
	 */
	public ProtocolWrapper(final Plugin plugin) {
		this.plugin = plugin;
