...
public class RequirementRegisterer {
  ...
  public RequirementRegisterer() {
    ...
    SuperiorPrisonPlugin.getInstance()
        .getHookController()
        .executeIfFound(() -> PapiHook.class, () -> add(new PapiRequirement()));
    SuperiorPrisonPlugin.getInstance()
        .getHookController()
        .executeIfFound(() -> VaultHook.class, () -> add(new EcoRequirement()));
  ...
  private void register() {
    reqs.forEach(
        SuperiorPrisonPlugin.getInstance().getRequirementController()::registerRequirement);
  }
}
