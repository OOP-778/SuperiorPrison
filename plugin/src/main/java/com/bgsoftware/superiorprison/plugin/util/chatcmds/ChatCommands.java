...
public class ChatCommands {
  ...
  @Setter private BiConsumer<Player, Throwable> exceptionHandler;
        ...
        new PlayerInput<String>(player)
            ...
            .onError(
                (b, t) -> {
                  ...
                  else exceptionHandler.accept(player, t);
                })
  ...
  private void handle(String message) {
    ...
    if (!first.isPresent()) {
      try {
        ...
        else exceptionHandler.accept(player, th);
      }
      return;
    }
    ...
    try {
      ...
      if (th instanceof NullPointerException) th.printStackTrace();
    ...
    } else if (afterInput != null) afterInput.run();
  }
