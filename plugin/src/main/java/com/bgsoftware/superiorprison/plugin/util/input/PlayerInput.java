...
public class PlayerInput<T> {
  ...
  @Getter @Setter private @NonNull BiConsumer<PlayerInput<T>, Throwable> onError;
  @Getter @Setter private @NonNull Function<String, T> parser;
  @Getter @Setter private @NonNull BiConsumer<PlayerInput<T>, T> onInput;
