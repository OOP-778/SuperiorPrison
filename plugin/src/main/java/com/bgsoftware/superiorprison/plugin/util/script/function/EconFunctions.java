...
import static com.bgsoftware.superiorprison.plugin.util.script.variable.VariableHelper.getElseCreate;
import static com.bgsoftware.superiorprison.plugin.util.script.variable.VariableHelper.getVariable;
